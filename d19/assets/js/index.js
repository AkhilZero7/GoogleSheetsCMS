function simpleTemplating(data) {
  ...
  $.each(data, function (index, value) {
    html +=
      '<article><a href="response.html?post=' +
      value.gsx$postid.$t +
      '" class="image"><img src="https://drive.google.com/uc?export=view&amp;id=' +
      value.gsx$url.$t +
      '" alt="" /></a>';
    html += "<h3>" + value.gsx$title.$t + "</h3>";
    html +=
      '<p><a href="?student=' +
      value.gsx$lastname.$t +
      value.gsx$firstname.$t +
      '">' +
      value.gsx$firstname.$t +
      " " +
      value.gsx$lastname.$t +
    ...
    html +=
      '<ul class="actions"><li><a href="response.html?post=' +
      value.gsx$postid.$t +
      '" class="button">More</a></li></ul></article>';
  });
  return html;
}
...
setTimeout(function () {
  // let's wait 2000 ms. hope it's enough to send the request and receive and read the response
...
var sheetUrl =
  "https://spreadsheets.google.com/feeds/list/1P2EgkyP3E2MPVAMxlDN9bFtSbJRBB9M76TDHMaBX4lM/1/public/values?alt=json";
